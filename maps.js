...
function buildAnimals() {
  ...
  const nodes = {
    ...
    '67':{x:150, y:255},
    '41':{x:100, y:260},
    '37':{x:178, y:225},  // doubles — bridges left-starts ↔ Purple Pup area
    ...
    '55':{x:710, y:400},
    '57':{x:758, y:528},
    '29':{x:845, y:555},  // fist dead-end

    // ── SE ARC: Punk Hare chain ────────────────────────────────────────────
    '58':{x:668, y:458},
    '59':{x:595, y:478},
    '18':{x:658, y:538},  // Punk Hare
    '60':{x:528, y:510},

    // ── S ARM: Primal Hare + White Wolf ────────────────────────────────────
    '17':{x:448, y:508},  // Primal Hare
    '61':{x:358, y:528},
    '62':{x:295, y:488},
    '63':{x:235, y:492},
    '16':{x:250, y:565},  // White Wolf
    '64':{x:195, y:562},
    '36':{x:200, y:535},  // doubles
